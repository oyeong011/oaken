...
| --- | ---: | --- | --- | --- |
| NVIDIA GeForce RTX 5060 | 8151 MiB | 590.48.01 | 13.1 | 8GB-class consumer GPU; baseline idle VRAM for OPT-1.3B and OPT-2.7B runs was 33 MiB. |
...
| RTX 5060 | OPT-2.7B | OK | Original FP16 eval, Oaken profiling, and Oaken eval completed on 8GB VRAM with both default and expandable allocator settings. |
...
| RTX 5060 | OPT-2.7B | 12.4688 | 12.5703 | +0.1015 | 140.44s script / 144.14s wrapper | 75.59s | 7.65GB default / 7.43GB expandable eval | 33 MiB | OK |
...
- The threshold artifacts are primarily Wikitext-derived; OPT-350M cross-dataset threshold stability has a separate dataset-stability analysis artifact.
...
1. Extend dataset-stability profiling beyond OPT-350M to larger model sizes where VRAM allows it.
2. Re-run PIQA threshold profiling after resolving the Hugging Face dataset-script loader incompatibility.
3. Compare threshold stability across datasets by layer, tensor type, and quantization group for OPT-1.3B and OPT-2.7B.
